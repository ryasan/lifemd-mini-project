  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4 font-sans overflow-hidden">
      <div className="w-full max-w-lg text-center">
        ...
        {/* Hero Header */}
        <h1 className="animate-intro-1 text-[26px] leading-[1.1] font-bold text-[#0F5C78] mb-3">
          LifeMD sets the standard for remarkable weight loss success.
        </h1>

        <p className="animate-intro-2 mb-10 text-[16px] text-[#1b3d50] font-semibold leading-snug">
          Over 1 million pounds and counting lost by patients on LifeMD's top-rated GLP-1 weight management program.
        </p>

        {/* Main Content Card */}
        <div className="animate-intro-3 rounded-3xl bg-[#E0F2F3] p-6 pb-10 mb-8 shadow-sm border border-[#cdeced]">
        ...
        {/* Bottom Offer */}
        <div className="animate-intro-4 text-[14px] text-[#808080] font-medium tracking-tight">
